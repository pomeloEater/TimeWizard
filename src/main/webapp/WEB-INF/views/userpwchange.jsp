			...
			<input type="hidden" name="user_no" value="${dto.user_no}">
				...
				<div class="toggle">
					<div class="pwchangebox">
						...
						<input type="password" id="newPW" class="newPW" name="newPW" placeholder="6~10자 " required="required"/>
					...
					<div class="pwchangebox">
						<input id="updatebtn" class="btn" type="submit" value="변경하기 " onclick="pw_change();"/>
